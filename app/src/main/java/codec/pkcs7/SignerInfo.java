...
public class SignerInfo extends ASN1Sequence {
    ...
    /**
     * The {@link codec.x509.AlgorithmIdentifier DigestAlgorithmIdentifier}.
     */
    protected AlgorithmIdentifier dAlg_;

    /**
     * The {@link codec.x509.AlgorithmIdentifier DigestEncryptionAlgorithmIdentifier}.
     */
    ...
    /**
     * The algorithm to use when a {@link codec.pkcs7.SignedData SignedData} instance is
     ...
     * {@link codec.pkcs7.SignedData SignedData} instances.
     */
     ...
     * embedded in the {@link codec.x509.SubjectPublicKeyInfo SubjectPublicKeyInfo} of the
	...
	serial_ = new ASN1Integer(new BigInteger(cert.getSerialNumber()));
     ...
     * then they are encoded as {@link codec.asn1.ASN1Null ASN1Null}. The signature
    ...
    /**
     * Adds the given {@link codec.x501.Attribute attribute} to the list of authenticated
    ...
    /**
     * Adds the given {@link codec.x501.Attribute attribute} to the list of unauthenticated
     * attributes. This method should be used to add attributes because it
     * clears the attributes instance's <code>OPTIONAL</code> flag.
     * Alternatively, this can be done manually.
     * 
    ...
    /**
     * Returns the {@link codec.x501.Name name} of the issuer of the certificate of this
     * signer.
     * 
     ...
     * it by means of the {@link codec.util.JCA JCA} and the
     * {@link codec.x509.AlgorithmIdentifier algorithm identifiers} embedded in this
     * structure.
     * 
     ...
     * algorithm name by means of the {@link codec.util.JCA JCA} class. This requires JSPs
     ...
     * {@link codec.x509.SubjectPublicKeyInfo SubjectPublicKeyInfo}. If either the digest
