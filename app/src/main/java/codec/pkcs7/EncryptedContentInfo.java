 ...
 * {@link codec.pkcs7.Data data}, {@link codec.pkcs7.SignedData signedData},
 * {@link codec.pkcs7.EnvelopedData envelopedData},
 * {@link SignedAndEnvelopedData signedAndEnvelopedData}, and
 * {@link codec.pkcs7.EncryptedData encryptedData}. All of these content types have
 * registered OIDs.
 * <p>
 * 
 * @author Volker Roth
...
public class EncryptedContentInfo extends ASN1Sequence {
     ...
     * parameters. The content type is set to {@link codec.pkcs7.Data Data}. Instances
     ...
     * stored in the given {@link codec.pkcs7.RecipientInfo RecipientInfo}. The BEK is
     ...
     *                the BEK.
     * @param info
     *                The {@link codec.pkcs7.RecipientInfo RecipientInfo} that holds the
     *                BEK.
    ...
    /**
     * This method initializes and returns a new {@link codec.pkcs7.RecipientInfo
     * RecipientInfo} based on the given certificate. The BEK must already be
     * initialized, otherwise an exception is thrown.
     * 
     * @param cert
     *                the certificate
     * @return the created {@link codec.pkcs7.RecipientInfo}
     * @throws java.security.GeneralSecurityException
