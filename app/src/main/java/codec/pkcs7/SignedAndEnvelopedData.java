...
public class SignedAndEnvelopedData extends ASN1Sequence implements
    ...
    /**
     * The {@link codec.pkcs7.SignerInfo SignerInfos}.
     */
    ...
    /**
     * The {@link codec.pkcs7.EncryptedContentInfo EncryptedContentInfo}.
     */
     ...
     * {@link codec.pkcs7.EncryptedContentInfo EncryptedContentInfo} is initialized
     ...
     * {@link codec.pkcs7.RecipientInfo RecipientInfo} instance is created and added to the
    ...
    /**
     * Adds the given {@link codec.pkcs7.SignerInfo SignerInfo} to this instance. This
     ...
     * {@link codec.pkcs7.Data Data}. If it is not data then the authenticated content type
     * must be given as an authenticated attribute in all the {@link codec.pkcs7.SignerInfo
     ...
     *                 if the content type is not {@link codec.pkcs7.Data Data}.
     * @throws java.security.GeneralSecurityException
    ...
    /**
     * This method retrieves the {@link codec.pkcs7.RecipientInfo RecipientInfo} macthing
     ...
     * {@link codec.pkcs7.RecipientInfo RecipientInfos} of this structure.
     * 
    ...
    /**
     * This method returns the {@link codec.pkcs7.SignerInfo SignerInfos} of the signers of
     * this structure.
     * 
     ...
     * those listed in the {@link codec.pkcs7.RecipientInfo recipient infos} of this
     * instance.
     * 
     * @param cert
     *                The certificate that identifies the recipient.
     ...
     * {@link codec.pkcs7.RecipientInfo RecipientInfo} matching the given certificate and
     * calls {@link codec.pkcs7.EncryptedContentInfo#init(java.security.PrivateKey, codec.pkcs7.RecipientInfo) init}
     * of the {@link codec.pkcs7.EncryptedContentInfo EncryptedContentInfo} contained in
     * this structure.
     * <p>
     * 
     ...
     * {@link codec.pkcs7.SignedData SignedData} structure.
     * 
     * @param kdk
     ...
     * @throws java.util.NoSuchElementException
     *                 if no matching {@link codec.pkcs7.RecipientInfo RecipientInfo} is
     ...
     * <p>
     * 
     * If this structure is signed with the {@link codec.pkcs7.Signer Signer} then the
     * {@link codec.pkcs7.SignerInfo SignerInfo} that is passed to it must have either:
     * <ul>
     ...
     * {@link codec.pkcs7.Data Data} or at least one other authenticated attribute is
    ...
    /**
     * This method wraps the given bytes into a {@link codec.pkcs7.Data Data} type and sets
     * it as the content.
     * <p>
     * 
    ...
    /**
     * Encrypts the given data and inserts it as {@link codec.pkcs7.Data Data} content. The
    ...
    /**
     * Sets the content type to {@link codec.pkcs7.Data Data} and clears the actual content.
