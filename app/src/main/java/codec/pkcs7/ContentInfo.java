 ...
 * six content types, of which five are supported: {@link codec.pkcs7.Data data},
 * {@link codec.pkcs7.SignedData signedData}, {@link EnvelopedData envelopedData},
...
public class ContentInfo extends ASN1Sequence {
     ...
     * {@link codec.pkcs.PKCSRegistry PKCSRegistry} is used for resolving OIDs to PKCS7
     * structures.
     */
    public ContentInfo() {
     ...
     * the {@link codec.pkcs.PKCSRegistry PKCSRegistry} is used.
     * 
     * @param registry
     ...
     * {@link codec.pkcs7.SignedData SignedData} type in the case of signing detached
     * signatures. Such signatures require the content type to be
     * {@link codec.pkcs7.Data Data}, but the actual data must be empty (no identifier,
     ...
     *                {@link codec.pkcs7.Data Data} content OID.
     */
    ...
    /**
     * This method calls {@link #setContent(codec.asn1.ASN1RegisteredType) setContent} with
     ...
     * {@link codec.asn1.ASN1RegisteredType#getOID ASN1RegisteredType.getOID()}.
     * 
     * @param type
     ...
     * the {@link codec.asn1.ASN1OpenType ASN1OpenType}.
     * 
     * @param decoder
     *                The {@link codec.asn1.Decoder Decoder} to use.
     */
