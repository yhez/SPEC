 ...
 * <p>
 * 
 * Presently, only content of type {@link codec.pkcs7.Data Data} is supported. Either
 * detached signatures may be generated (in which case the content consists of a
 * {@link codec.pkcs7.Data Data} type with no content) or the payload may be embedded into
 * the content info of this structure (automatically wrapped into a
 * {@link codec.pkcs7.Data Data} type.
 * <p>
 * 
...
public class SignedData extends ASN1Sequence implements ASN1RegisteredType,
     ...
     * type {@link codec.pkcs7.Data Data}. If it is not data then the authenticated content
     ...
     * type {@link codec.pkcs7.Data Data}. The actual content type can be retrieved by
     ...
     *    codec.pkcs7.Data#getByteArray() getByteArray}()
     * </code>
     * 
     ...
     * type {@link codec.pkcs7.Data Data} and the content contained in it is not null.
     * 
