 ...
 * The OID are mapped to algorithm names and vice versa by the {@link codec.util.JCA JCA}
...
public class RecipientInfo extends ASN1Sequence {
    ...
    /**
     * The {@link codec.x509.AlgorithmIdentifier KeyEncryptionAlgorithmIdentifier}.
     */
     ...
     * {@link codec.x509.AlgorithmIdentifier AlgorithmIdentifier} that is embedded in the
     * public key's encoding. Decoding is done using a
     * {@link codec.x509.SubjectPublicKeyInfo SubjectPublicKeyInfo} instance.
     * 
     * @param cert
     ...
     * {@link codec.util.JCA JCA}. If the name consists of an OID then either the
