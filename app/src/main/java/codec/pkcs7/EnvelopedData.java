...
public class EnvelopedData extends ASN1Sequence implements ASN1RegisteredType {
    ...
    /**
     * The {@link codec.pkcs7.ContentInfo ContentInfo}.
     */
     ...
     * calls {@link EncryptedContentInfo#init(java.security.PrivateKey, RecipientInfo) init}
    ...
    /**
     * Encrypts the given data and inserts it as {@link codec.pkcs7.Data Data} content.
     * 
