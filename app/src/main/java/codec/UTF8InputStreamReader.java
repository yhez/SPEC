...
public class UTF8InputStreamReader extends Reader {
     ...
     *
     * @param i       the InputStream object from which the input will be read.
     * @param bufsize the size which must be buffered.
     */
     ...
     * initialized.
     *
     * @throws java.io.IOException if the InputStream is <code>null</code>
     */
