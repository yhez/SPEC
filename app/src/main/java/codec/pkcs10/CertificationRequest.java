 ...
 * #CertificationRequest(java.security.PublicKey, codec.x501.Name)} with your public key and name. After
 * that, you have to call {@link #getTBS()} to get the to-be-signed (tbs) data,
 * sign them outside and call {@link #setSignature(byte[], codec.x509.AlgorithmIdentifier)}
...
public class CertificationRequest extends ASN1Sequence {
     ...
     * #setSignature(byte[], codec.x509.AlgorithmIdentifier)} to fill-in the signature
     ...
     * outside and call {@link #setSignature(byte[], codec.x509.AlgorithmIdentifier)} to *
