...
public class SubjectPublicKeyInfo extends ASN1Sequence {
     ...
     *
     * @param aid AlgorithmIdentifier of the public key algorithm
     * @param key The encoded key material.
     ...
     *
     * @param aid The AlgorithmIdentifier of the public key algorithm.
     * @param key The public key as a ASN.1 data structure.
     */
     ...
     * @throws java.security.InvalidKeyException if the key cannot be decoded properly.
     ...
     * @throws InconsistentStateException             if the key spec generated by this method is rejected by
     *                                                the key factory that is used to generate the key.
     * @throws java.security.NoSuchAlgorithmException if there is no key factory registered for the algorithm
     ...
     *
     * @param key The public key from which this instance is initialized.
     * @throws java.security.InvalidKeyException if the given key cannot be decoded properly.
     * @throws NullPointerException              if the given key is <code>null</code>.
     */
     ...
     *
     * @throws InconsistentStateException if an internal error occurs while the key is encoded.
     ...
     *
     * @param aid AlgorithmIdentifier of this public key
     */
    ...
    /**
     * @param derDecode <code>true</code> if the raw key shall be decoded.
