 ...
 * </blockquote>
 * 
 * Instances can be initialized with a {@link codec.asn1.OIDRegistry OIDRegistry} that is
...
public class Attributes extends ASN1SetOf {
     ...
     * {@link codec.asn1.OIDRegistry OIDRegistry} is used to resolve the attribute value
