...
public class DERDecoder extends FilterInputStream implements Decoder {
    ...
    /**
     * This method also reads in {@link codec.asn1.ASN1Opaque ASN1Opaque} types. Opaque
     ...
     *                {@link codec.asn1.ASN1Opaque ASN1Opaque} to decode.
     */
     ...
     * alternative types is provided by the given {@link codec.asn1.ASN1Choice ASN1Choice}
     * instance. The choice must be unambiguous.
     * <p>
     * The CHOICE elements <b>must</b> be tagged EXPLICIT. Otherwise, the
     * decoding will abort with an exception. The {@link codec.asn1.ASN1Choice ASN1Choice}
