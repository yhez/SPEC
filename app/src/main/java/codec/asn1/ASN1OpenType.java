 ...
 * encoding results in an {@link codec.asn1.ASN1Null ASN1Null} being decoded.
 * <p>
 * 
...
public class ASN1OpenType extends ASN1AbstractType {
     ...
     * using the given {@link codec.asn1.Resolver Resolver}.
     * 
     * @param resolver
     ...
     * {@link codec.asn1.Resolver Resolver} is set then the Resolver is asked to resolve
    ...
    /**
     * Sets the {@link codec.asn1.Constraint Constraint} of the inner type. For instance an
     ...
     * 
     * @param constraint
     *                The {@link codec.asn1.Constraint Constraint} of this type.
     * @throws IllegalStateException
     *                 if the inner type is not yet initialized.
     */
     ...
     * <p>
     * If an exception is thrown by the {@link codec.asn1.Resolver Resolver} upon resolving
     ...
     * {@link codec.asn1.Encoder Encoder}. If the inner type is not yet initialized then
     * an exception is thrown.
     * 
     * @param enc
     *                The {@link codec.asn1.Encoder Encoder} to use for encoding the inner
     *                type.
     * @throws IllegalStateException
     *                 if the inner type is not yet initialized.
     */
    ...
    /**
     * Decodes the inner type to the given {@link codec.asn1.Decoder decoder}. If a
     * {@link codec.asn1.Resolver resolver} was specified then it is asked to provide an
