...
public class DEREncoder extends AbstractEncoder {
     ...
     * headers of types that are tagged {@link codec.asn1.ASN1Type#isExplicit EXPLICIT} are
    ...
    /**
     * Writes an arbitrary {@link codec.asn1.ASN1Type ASN1Type}. The given type is written
     * only if it is not declared OPTIONAL. The type is written by calling its
     * {@link codec.asn1.ASN1Type#encode encode} method with <code>this</code> as the
     ...
     * and length octets of the {@link codec.asn1.ASN1Type ASN.1 type} with the given tag
