...
public class ASN1SetOf extends ASN1Set implements ASN1CollectionOf {
    /**
     * The {@link codec.asn1.ASN1Type ASN1Type} from which the component types of this
     ...
     * be a valid {@link codec.asn1.ASN1Type ASN1Type}. The given class must be public and
    ...
    /**
     * Creates an instance that uses the given {@link codec.asn1.Resolver Resolver} to
     * create new elements.
     * 
     * @param resolver
     ...
     * <p>
     * 
     * <b>{@link codec.asn1.Decoder Decoders} should call this method in order to create
    ...
    /**
     * Reads this collection from the given {@link codec.asn1.Decoder Decoder}.
     * 
     * @param dec
