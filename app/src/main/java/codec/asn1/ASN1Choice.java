 ...
 * {@link codec.asn1.ASN1Type#getTag getTag}, {@link codec.asn1.ASN1Type#getTagClass getTagClass},
 * {@link codec.asn1.ASN1Type#getValue getValue} all return the appropriate results of the
...
public class ASN1Choice extends ASN1AbstractType {
     ...
     * this method calls {@link codec.asn1.ASN1Type#setOptional setOptional}(false) and
     * {@link codec.asn1.ASN1Type#setExplicit setExplicit}(true) on the given type.
     ...
     *                class {@link codec.asn1.ASN1 ASN1}.
     * @param tagclass
     *                The tag class of the type encountered in the encoded
     *                stream. The tag class identifiers are defined in class
     *                {@link codec.asn1.ASN1 ASN1}. See for instance
     *                {@link codec.asn1.ASN1#CLASS_UNIVERSAL CLASS_UNIVERSAL}.
     ...
     * {@link codec.asn1.ASN1Null ASN1Null}. This method calls
     * {@link codec.asn1.ASN1Type#getValue getValue} on the inner type and returns the
     * result.
     * 
     ...
     * The OPTIONAL flag is checked only by {@link codec.asn1.Encoder encoders} and
     * {@link codec.asn1.Decoder decoders}. Transparent handling of CHOICE types can be
     * achieved by calling <code>{@link codec.asn1.Encoder#writeType
     * writeType}(ASN1Choice choice)</code>
     * on the encoder. The encoder's method checks if its argument is OPTIONAL.
     * 
     * @param enc
     *                The {@link codec.asn1.Encoder Encoder} to use for encoding.
     * @throws IllegalStateException
     *                 if the inner type is not set.
     */
    ...
    /**
     * Decodes the inner type to the given {@link codec.asn1.Decoder decoder}.
     * 
     * @param dec
