...
public class DESede extends BlockCipher {
     ...
     * @param params algorithm parameters (not used)
    ...
    /**
     * @param key the single SecretKey which has to be used to decrypt data
     * @param in  long integer which contains the ciphertext to be decrypted
     */
