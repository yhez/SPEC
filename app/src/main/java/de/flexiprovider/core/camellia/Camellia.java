...
public class Camellia extends BlockCipher {
     ...
     *
     * @param key An array of bytes containing the key data
     */
     ...
     * .
     *
     * @param input  array of bytes containing the plaintext to be encrypted
     ...
     * .
     *
     * @param input  array of bytes containig the ciphertext to be decrypted
     ...
     *
     * @param x    the array containing the first block
     * @param offx the offset where the first block starts
     * @param y    the array containing the second block
     * @param offy the offset where the second block starts
     * @param z    the array containing the result
     * @param offz the offset where the result starts
     */
     ...
     *
     * @param x    the byte array containing the block
     * @param offx the offset where the block starts
     */
     ...
     *
     * @param input  the byte array containing the block
     * @param inOff  the offset where the block starts
     * @param output the output array
     * @param outOff the offset where the output starts
     */
     ...
     * @param inOff  the offset where the 4 integers start
     * @param output the output array
     * @param outOff the offset where the block starts
     */
