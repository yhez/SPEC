...
public class SAFERPlus extends BlockCipher {
     ...
     *
     * @param in        array of bytes which contains the plaintext to be encrypted
     * @param inOffset  index in array in, where the plaintext block starts
     * @param out       array of bytes which will contain the ciphertext
     ...
     * at <TT>outOffset</TT>
     *
     * @param in        array of bytes which contains the ciphertext to be decrypted
     * @param inOffset  index in array in, where the ciphertext block starts
     * @param out       array of bytes which will contain the plaintext starting at
     *                  outOffset
     ...
     *
     * @param length the number of subkeys which will be needed (equivalent to the
     ...
     *
     * @param l The number of bytes, which will be rotated
     */
     ...
     * (bitwise mod 2).
     *
     * @param indexSet array containing the indexes of the bytes which shall be
     *                 changed.
     * @param keyNum   number of the actual subkey
     */
     ...
     *
     * @param set array containing the indexes of the bytes which shall be
     *            changed.
     */
