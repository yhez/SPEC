...
public class RC5 extends BlockCipher {
     ...
     * @throws IllegalStateException if called before initializing the cipher.
     */
     ...
     *
     * @param key    SecretKey to be used to encrypt data
     * @param params AlgorithmParamterSpec to be used with this algorithm
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException                if the given key is illegal for this cipher.
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the given AlgorithmParameters are not appropriate for this
     *                                                                            cipher.
     */
     ...
     *
     * @param key    SecretKey to be used to decrypt data
     * @param params AlgorithmParamterSpec to be used with this algorithm
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException                if the given key is illegal for this cipher
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the given AlgorithmParameters are not appropriate for this
     *                                                                            cipher
     ...
     * at <TT>outOffset</TT>
     *
     * @param in        byte[] containing the plaintext to be encrypted starting at
     *                  inOffset
     * @param inOffset  int index in the array in where the plaintext block starts
     * @param out       byte[] which will contain the ciphertext startig at outOffset
     * @param outOffset int index in the array out where the ciphertext block will
     *                  start
     */
     ...
     * at <TT>outOffset</TT>
     *
     * @param in        byte[] containing the ciphertext to be decrypted starting at
     *                  inOffset
     * @param inOffset  int index in the array in where the ciphertext block starts
     * @param out       byte[] which will contain the plaintext startig at outOffset
     * @param outOffset int index in the array out where the plaintext block will
     *                  start
     */
     ...
     * little-endian
     *
     * @param bytes         the byte array to hold the result
     * @param offset        the integer offset into the byte array
     * @param value         the long to convert
     * @param numberOfBytes the number of Bytes to convert within the long value
     */
