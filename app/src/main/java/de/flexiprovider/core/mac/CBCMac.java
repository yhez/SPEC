...
public abstract class CBCMac extends Mac {
     ...
     *
     * @param blockCipher the cipher algorithm to use
     */
     ...
     * the given position.
     *
     * @param input byte array containing the message to be processed
     * @param inOff offset into the array to start from
     * @param inLen number of bytes to be processed
     */
