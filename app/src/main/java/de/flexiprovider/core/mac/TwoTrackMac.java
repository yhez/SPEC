...
/**
 * This class extends the {@link de.flexiprovider.api.Mac} class for providing the functionality of
...
public abstract class TwoTrackMac extends Mac {
     ...
     *
     * @param len the bitlength of the MAC. Possible lengths are 32, 64, 96, 128
     *            and 160.
     */
     ...
     * @param params the parameters are not used.
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the key size is invalid.
     */
     ...
     * the given position.
     *
     * @param bytes  byte array containing the message to be processed
