...
public class SSVElGamal extends AsymmetricBlockCipher {
     ...
     *
     * @param sgElement an element from the subgroup Zq
     * @return the padded message
     */
     ...
     * @param pm the padded message
     * @return the message
     * @throws de.flexiprovider.api.exceptions.BadPaddingException if the padded message is invalid.
     */
