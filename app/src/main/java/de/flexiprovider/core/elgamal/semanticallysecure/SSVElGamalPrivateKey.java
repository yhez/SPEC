...
public class SSVElGamalPrivateKey extends PrivateKey {
     ...
     * The constructor.
     *
     * @param modulusp  - the prime modulus which specifies the group
     * @param modulusq  - the prime modulus which specifies the subgroup
     * @param generator - a generator of the group
     * @param publicA   - the public value <tt>A = g<sup>a</sup> mod modulusp</tt>
     * @param a         - the private value <tt>a</tt>
     */
