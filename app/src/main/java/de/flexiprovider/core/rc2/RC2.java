...
public class RC2 extends BlockCipher {
     ...
     *
     * @param key    the SecretKey which has to be used to decrypt data.
     * @param params algorithmParameterSpec, not used for here
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the given key is inappropriate for initialising this
     *                                                             cipher.
     */
