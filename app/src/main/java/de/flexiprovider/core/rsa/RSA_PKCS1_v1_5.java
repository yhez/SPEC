...
public class RSA_PKCS1_v1_5 extends AsymmetricBlockCipher {
     ...
     *                                                                            cipher.
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the bit length of the modulus is too small.
     */
     ...
     * @throws de.flexiprovider.api.exceptions.BadPaddingException if a PKCS1Exception is thrown by the encryption
     *                                                             primitive.
     */
     ...
     * @throws de.flexiprovider.api.exceptions.IllegalBlockSizeException if the length of the input does not match the expected
     *                                                                   length.
     * @throws de.flexiprovider.api.exceptions.BadPaddingException       if the decrypted header does not match the expected
