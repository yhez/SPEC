...
public class PSSParameters extends AlgorithmParameters {
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidParameterSpecException if the parameter specification is <tt>null</tt> or nor
     ...
     * @throws java.io.IOException on decoding errors or if the encoding format is
     ...
     * @param format the encoding format
     * @return the encoded parameters
     * @throws java.io.IOException on encoding errors or if the encoding format is
     *                             <tt>null</tt> or not equals to "ASN.1".
     */
     ...
     *
     * @param paramSpec the desired parameter specification type
     * @return the parameter specification
     * @throws de.flexiprovider.api.exceptions.InvalidParameterSpecException if the parameter specification type is <tt>null</tt> or
