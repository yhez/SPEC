...
public final class PKCS1Operations {
     ...
     *
     * @param M octet string to be hashed
     ...
     * @param xLen intended maximum length of the resulting octet string or 0
     ...
     * @param m      message to be encrypted (RSAEP) <b>or</b> signature to be
     *               verified (RSAVP1)
     ...
     * @param c       ciphertext to be decrypted (RSADP) <b>or</b> plaintext be
     *                signed (RSASP1)
     ...
     *
     * @param L    a label, optional. pass <tt>null</tt> if label empty.
     * @param M    message to be encoded
     * @param k    the encoding length
     * @param md   message digest that will be used for hashing the message
     * @param prng source of cryptographically secure pseudo-randomness
     ...
     * @param L  a label, optional. pass <tt>null</tt> if not required.
     * @param k  the encoding length
     ...
     * @param M      the message
     * @param EM     the encoded message
     * @param emBits the bit length of the encoded message
     * @param md     the message digest
     ...
     *
     * @param seed   the seed
     * @param length the intended output length
     * @param md     the message digest
