...
public final class ShacalKeyFactory extends SecretKeyFactory {
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeySpecException if the key specification is of the wrong type.
     */
     ...
     * {@link de.flexiprovider.api.keys.SecretKeySpec}. The key has to be an instance of {@link de.flexiprovider.core.shacal.ShacalKey}
     * .
     *
     * @param key     the key
     ...
     * format
     * @throws de.flexiprovider.api.exceptions.InvalidKeySpecException if the requested key specification is inappropriate for the
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the given key cannot be processed by this key factory.
     */
