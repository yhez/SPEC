 ...
 * {@link de.flexiprovider.core.saferplusplus.SAFERPlusPlusKeyGenerator}. The parameters consist of the key size in
...
public class SAFERPlusPlusKeyGenParameterSpec implements AlgorithmParameterSpec {
     ...
     *
     * @param keySize the key size (128 or 256 bits)
     */
