...
public class SAFERPlusPlus extends BlockCipher {
     ...
     * @param paramSpec - algorithmParameterSpec, not used for here
     ...
     * .
     *
     * @param in        array of bytes containing the plaintext to be encrypted
     * @param inOffset  index in array <tt>in</tt> where the plaintext block starts
     * @param out       array of bytes which will contain the ciphertext starting at
     *                  <tt>outOffset</tt>
     * @param outOffset index in array <tt>out</tt> where the ciphertext block will
     *                  start
     */
     ...
     * @param inOff  index in array <tt>in</tt> where the ciphertext block starts
     * @param output array of bytes which will contain the plaintext starting at
     *               <tt>outOffset</tt>
     * @param outOff index in array <tt>out</tt> where the plaintext block will
     *               start
     */
