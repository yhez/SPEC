...
public abstract class DSASignature extends
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the key is not an instance of DSAPrivKey.
     */
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the public key is not an instance of DSAPubKey.
     */
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the given parameters are inappropriate for this signature
     *                                                                            engine
     */
