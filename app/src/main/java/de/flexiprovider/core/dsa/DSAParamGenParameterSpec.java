...
public class DSAParamGenParameterSpec implements AlgorithmParameterSpec {
     ...
     * Constructor.
     *
     * @param keySize the bit length of the prime <tt>p</tt> (1024 or 2048)
     * @throws de.flexiprovider.api.exceptions.InvalidParameterException if the key size is invalid.
     */
     ...
     * Constructor.
     *
     * @param L the bit length of the prime <tt>p</tt>
     * @param N the bit length of the prime <tt>q</tt>
     * @throws de.flexiprovider.api.exceptions.InvalidParameterException if <tt>L &lt; 1</tt> or <tt>N &lt; 1</tt>.
     */
