...
public class MeRSAKeyPairGenerator extends KeyPairGenerator {
     ...
     * randomness.
     *
     * @param keySize    the bit length of the prime p
     * @param secureRand the source of randomness.
     */
    ...
    /**
     * Generate a MeRSA key pair, consisting of a {@link de.flexiprovider.core.mersa.MeRSAPrivateKey} and an
