...
public final class MeRSAOperations {
     ...
     *
     * @param pubKey the public MeRSA key
     * @param m      message to be encrypted (MeRSAEP) <b>or</b> signature to
     ...
     * @param c       ciphertext to be decrypted <b>or</b> plaintext be signed
