...
public class MeRSASignaturePSS extends Signature {
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the key is not an instance of MeRSAPrivateKey
     */
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the public key is not an instance of RSAPublicKey.
     */
