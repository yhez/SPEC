...
public class IQDSAParameters extends AlgorithmParameters {
    ...
    private static class IQDSAASN1Parameters extends ASN1Sequence {
         ...
         * @param gamma        the generator of the class group
         */
         ...
         * @throws IQEncodingException if the generator of the class group cannot be
         *                             encoded.
         */
     ...
     * @throws InvalidParameterSpecException if the parameter specification is not an instance of
     ...
     * @throws java.io.IOException on decoding errors or if the encoded parameters are
     *                             <tt>null</tt>.
     */
     ...
     * @throws java.io.IOException on decoding errors, or if this parameter object has
