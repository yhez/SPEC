...
public class IQRDSAPrivateKey extends PrivateKey {
     ...
     *
     * @param params parameters consisting of gamma and prime modulus
     * @param gamma  the base element of the NFDL-problem
     * @param alpha  the public key value
     * @param a      the private key value
     */
