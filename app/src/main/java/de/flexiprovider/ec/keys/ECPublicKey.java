...
public class ECPublicKey extends PublicKey {
     ...
     *
     * @param w      the point that represents the public key
     ...
     *
     * @param encodedW the encoded point that represents the public key
     */
     ...
     * @throws InvalidKeyException if the key has not been initialized with EC domain
     *                             parameters yet.
     * @see de.flexiprovider.common.math.ellipticcurves.Point
     */
