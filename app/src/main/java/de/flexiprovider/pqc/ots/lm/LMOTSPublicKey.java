...
public class LMOTSPublicKey extends PublicKey {
     ...
     *
     * @param hFunction the Hash function for further use
     * @param hk        the hash value of the Vector K of the private Key
     * @param hl        the hash value of the Vector L of the private Key
     */
