...
public class GMSSRootSig {
     ...
     */
    public GMSSRootSig(String[] name, byte[][] statByte, int[] statInt) {
        ...
        this.mdsize = messDigestOTS.getDigestLength();
     ...
     */
    public GMSSRootSig(String[] name, int w, int height) {
    ...
    public void initSign(byte[] seed0, byte[] message) {
        ...
        this.hash = messDigestOTS.digest();
     ...
     */
    public boolean updateSign() throws SignatureException {
        // steps times do
