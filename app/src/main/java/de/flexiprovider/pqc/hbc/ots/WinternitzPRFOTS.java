...
public class WinternitzPRFOTS implements OTS {
     ...
     *
     * @param mBytes   the message
     * @param sigBytes the one-time signature
     ...
     * {@link #init(de.flexiprovider.api.MessageDigest, PRNG)}.
     */
     ...
     * @param rng the RNG used for key pair generation
     */
     ...
     *
     * @param value  : byte array of the value to be converted
     * @param length : length of number of the value converted to base w
     ...
     *
     * @param mBytes the message
     * @param sBytes the signature
     * @param pBytes the verification key
