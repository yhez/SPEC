...
public class NiederreiterPrivateKeySpec implements KeySpec {
     ...
     * @param m            extension degree of the field
     * @param k            dimension of the code
     * @param encField     encoded finite field
     * @param encGoppaPoly encoded irreducible Goppa polynomial
     * @param encS         encoded k x k random binary non-singular matrix
     * @param encP         encoded permutation vector
     * @param encQInv      encoded matrix used to compute square roots in
     *                     <tt>(GF(2<sup>m</sup>))<sup>t</sup></tt>
     */
