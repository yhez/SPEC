...
public class RainbowSignature extends Signature {
     ...
     *
     * @param privateKey the private key of the signature
     * @param random     the source of randomness
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the key is not an instance of RSAPrivateKey or
     *                                                             RSAPrivateCrtKey.
     */
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidKeyException if the key is not an instance of RainbowPublicKey
     */
     ...
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException. if the given parameters are
     ...
     *
     * @param the signature of the message is given as a byte array.
