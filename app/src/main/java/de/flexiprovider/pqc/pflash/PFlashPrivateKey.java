...
public class PFlashPrivateKey extends PrivateKey {
     ...
     *
     * @param m_S      Matrix of map S
     * @param c_S      Vector of map S
     * @param m_T      Matrix of map T
     * @param c_T      Vector of map T
     * @param poly_384 field polynomial of GF(2<sup>384</sup>)
     */
     ...
     *
     * @param keySpec a {@link PFlashPrivateKeySpec}
     */
