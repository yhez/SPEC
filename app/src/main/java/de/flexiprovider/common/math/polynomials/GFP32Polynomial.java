...
public class GFP32Polynomial {
	 ...
	 * 
	 * @param encoded
	 *            the byte array containing the encoded {@link de.flexiprovider.common.math.polynomials.GFP32Polynomial}
	 ...
	 * 
	 * @param gfp
	 *            the {@link de.flexiprovider.common.math.polynomials.GFP32Polynomial} to compare to.
	 * @return
	 */
