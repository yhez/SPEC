...
public class ProductFormConvolutionPolynomial implements ConvolutionPolynomial {
     ...
     * @param d1 the number of non-zero coefficients of the first sparse
     *           binary polynomial
     * @param d2 the number of non-zero coefficients of the second sparse
     *           binary polynomial
     * @param d3 the number of non-zero coefficients of the third sparse
     *           binary polynomial
     * @param sr the source of randomness used for creating the sparse
     *           binary polynomial
     */
     ...
     * polynomials.
     *
     * @param f1 the first sparse binary polynomial
     * @param f2 the second sparse binary polynomial
     * @param f3 the third sparse binary polynomial
     * @throws ArithmeticException if the sparse binary polynomials are not elements of the
     *                             same ring
     */
     ...
     * Copy constructor.
     *
     * @param other another <tt>ModQPolynomialProductForm</tt>
     */
    public ProductFormConvolutionPolynomial(
     ...
     * @param d3   the number of non-zero coefficients of the third sparse
     *             binary polynomial
     * @param enc1 the first encoded sparse binary polynomial
     * @param enc2 the second encoded sparse binary polynomial
     * @param enc3 the third encoded sparse binary polynomial
     * @throws IllegalArgumentException if the encoded polynomials have wrong length.
     */
     ...
     * @throws ArithmeticException if this polynomial is not a binary element of
     *                             <tt>Z(X)/(X^N-1)</tt>.
     */
