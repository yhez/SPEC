...
public class BinaryConvolutionPolynomial implements ConvolutionPolynomial {
     ...
     * @throws IllegalArgumentException if the degree of the given coefficient array is
     *                                  <tt>&gt;= N</tt>.
     */
     ...
     * Copy constructor.
     *
     * @param other another <tt>BinaryPolynomial</tt>
     */
     ...
     *
     * @param index the index of the coefficient to test
