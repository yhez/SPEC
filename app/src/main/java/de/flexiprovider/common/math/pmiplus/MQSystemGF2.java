...
public class MQSystemGF2 {
     ...
     *
     * @param point bytes representation of A
     ...
     *
     * @param field finite field GF(2^n)
     ...
     *
     * @param mqs is system of polynomials {gi}
     ...
     * {gi} is given
     *
     * @param mqs system of polynomials {gi}
