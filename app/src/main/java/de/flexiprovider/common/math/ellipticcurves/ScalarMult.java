...
public final class ScalarMult {
     ...
     *
     * @param p Array of base points
     * @param b Array of <tt>FlexiBigInt</tt>
     ...
     *
     * @param p base point
     * @param w upper bound/ window width
     ...
     * found in Pre[i].
     *
     * @param Q base point array. All points must be on the same elliptic
     *          curve.
     * @param W upper bound array. W[i] is the upper bound for P[i].
     ...
     * @param w window size
     * @param k the number of points to compute
     ...
     * @param P base point
     * @param Q base point
     * @param w window size (parameter of the simultaneous 2<sup>w</sup>-ary-method)
     ...
     * @param P base point
     * @param Q base point
     * @param w window size (parameter of the simultaneous sliding window
     *          method)
     ...
     * @param Q0 base point
     * @param Q1 base point
     * @param w  recoding parameter / upper bound. This parameter will be
     *           used for all points.
     ...
     * @param q0 base point
     * @param q1 base point
     * @param w  recoding parameter / upper bound
     * @return 2-dimensional point matrix <tt>P[i][j]</tt>.<br>
     * <tt>P[i][.] = i*Q<sub>0</sub> + ...</tt> if <tt>i</tt> is
     * odd;<br>
     * <tt>P[i][.] = (-i + 1)*Q<sub>0</sub> + ...</tt> if <tt>i</tt>
     ...
     *
     * @param p base point
     * @param m <tt>FlexiBigInt</tt>
     * @param n LimLee parameter (number of the splitted pieces)
     ...
     * MSB (Right-to-Left).
     *
     * @param e <tt>FlexiBigInt</tt> to be recoded
     * @param w window size.
     ...
     *
     * @param w window width (parameter of wMOF)
     ...
     * 3, -3,..., 2<sup>w - 1</sup> - 1}.
     *
     * @param d <tt>FlexiBigInt</tt> to be recoded
     * @param w window width (parameter of wMOF)
     * @return int-array representing the recoding
     */
     ...
     *
     * @param d Array of <tt>FlexiBigInt</tt>
     ...
     *
     * @param e0 <tt>FlexiBigInt</tt>
     * @param e1 <tt>FlexiBigInt</tt>
     ...
     *
     * @param d1 <tt>FlexiBigInt</tt>
     * @param d2 <tt>FlexiBigInt</tt>
     * @param w  window size
     * @return 2-lined matrix.<br>
     ...
     * {@link #pre_simultaneousSlidingWindow(de.flexiprovider.common.math.ellipticcurves.Point P, de.flexiprovider.common.math.ellipticcurves.Point Q, int w) here}.
     *
     * @param d1 <tt>FlexiBigInt</tt>
     * @param d2 <tt>FlexiBigInt</tt>
     * @param w  window size
     ...
     *
     * @param e array of FlexiBigInts to be recoded
     * @param w wNaf parameters. For the recoding of e[i], w[i] will be
     *          used.
     ...
     * <tt>P</tt>.
     *
     * @param N the recoded scalar as int-array
     * @param P array with the precomputed positive odd powers.<br>
     *          <tt>P[i] = (2i + 1)*p</tt>
     * @return <tt>m*p</tt>
     */
     ...
     *
     * @param N the recoded scalar as int-array
     * @param P array with the precomputed positive powers.<br>
     *          <tt>P[i] = (i + 1)*p</tt>
     * @return <tt>m*p</tt>
     */
     ...
     *          <tt>e<sub>i</sub></tt>;
     * @param P matrix with the precomputed powers. Use the
     *          {@link #pre_shamir(de.flexiprovider.common.math.ellipticcurves.Point Q0, de.flexiprovider.common.math.ellipticcurves.Point Q1, int w)  Shamir
     *          precomputation}.
     ...
     * negative) digits is supported.
     *
     * @param N 3-lined matrix.<br>
     *          line i contains the recoded representation of
     *          <tt>e<sub>i</sub></tt>;
     * @param P matrix with the precomputed powers. Use the
     *          {@link #pre_shamir(de.flexiprovider.common.math.ellipticcurves.Point Q0, de.flexiprovider.common.math.ellipticcurves.Point Q1, de.flexiprovider.common.math.ellipticcurves.Point Q2, int w)  Shamir
     *          precomputation}.
     ...
     * negative) digits is supported.
     *
     * @param N 4-lined matrix.<br>
     *          line i contains the recoded representation of
     *          <tt>e<sub>i</sub></tt>;
     * @param P matrix with the precomputed powers. Use the
     *          {@link #pre_shamir(de.flexiprovider.common.math.ellipticcurves.Point Q0, de.flexiprovider.common.math.ellipticcurves.Point Q1, de.flexiprovider.common.math.ellipticcurves.Point Q2, de.flexiprovider.common.math.ellipticcurves.Point Q3, int w)
     ...
     *
     * @param N matrix with the receoded representations.<br>
     *          Line i contains the wNaf-representation of
     *          <tt>e<sub>i</sub></tt>.
     * @param P point matrix with the precomputed points.<br>
