...
public final class ASN1Tools {
     ...
     * value.
     *
     * @param value the {@link de.flexiprovider.common.math.FlexiBigInt} value
     ...
     *
     * @param value the {@link codec.asn1.ASN1Integer}
     ...
     *
     * @param type the ASN.1 structure
     ...
     *
     * @param encoding the encoded ASN.1 structure
     * @param type     the type holding the decoding
     * @throws java.io.IOException      on decoding errors.
     * @throws codec.asn1.ASN1Exception on decoding errors.
     */
