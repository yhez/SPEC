...
public abstract class AlgorithmParameterGenerator extends
     ...
     *
     * @param genParamSpec the parameter specification
     * @param javaRand     the source of randomness
     * @throws java.security.InvalidAlgorithmParameterException if the given parameters are invalid.
     */
     ...
     * @param genParamSpec the parameter specification
     * @param random       the source of randomness
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the given parameters are invalid.
     */
