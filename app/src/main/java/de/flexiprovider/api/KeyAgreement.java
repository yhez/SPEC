...
public abstract class KeyAgreement extends KeyAgreementSpi {
     ...
     * @throws IllegalStateException if the object is not in doPhase.
     */
     ...
     *
     * @param sharedSecret the buffer to hold the shared secret
     * @param offset       the offset in <tt>sharedSecret</tt> where the shared
     *                     secret will be stored
     * @return the number of bytes written in <tt>sharedSecret</tt>
     * @throws IllegalStateException             if the key agreement scheme has not been initialized
     *                                           properly.
     * @throws javax.crypto.ShortBufferException if <tt>sharedSecret</tt> is too small to to hold the
     *                                           shared secret
     */
     ...
     * <tt>algorithm</tt>.
     *
     * @param algorithm the desired algorithm for the generation of the secret
     * @return the shared secret
     * @throws IllegalStateException                  if the key agreement scheme has not been initialized
     *                                                properly.
     * @throws java.security.NoSuchAlgorithmException if <tt>algorithm</tt> is invalid.
     */
    ...
    /**
     * JCA adapter for FlexiAPI method {@link #doPhase(de.flexiprovider.api.keys.PublicKey, boolean)}:
     ...
     * @param lastPhase <tt>true</tt> if this is the last phase of the key
     ...
     *
     * @param privKey the private key of the party initializing the key
     *                agreement
     * @param params  the algorithm parameters
     ...
     * @throws IllegalStateException                                if the key agreement scheme has not been initialized
     *                                                              properly.
     * @throws de.flexiprovider.api.exceptions.ShortBufferException if <tt>sharedSecret</tt> is too small to to hold the
     *                                                              shared secret
     */
     ...
     * @throws IllegalStateException                                    if the key agreement scheme has not been initialized
     *                                                                  properly.
     * @throws de.flexiprovider.api.exceptions.NoSuchAlgorithmException if <tt>algorithm</tt> is invalid.
     */
     ...
     * agreement.
     *
     * @param pubKey    the public key of the other party
     * @param lastPhase <tt>true</tt> if this is the last phase of the key
     *                  agreement. After the last phase only
     *                  <tt>generateSecret</tt> may be called.
     * @return the shared secret
