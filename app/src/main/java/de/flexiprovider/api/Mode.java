...
public abstract class Mode {
     ...
     *
     * @param blockCipher the block cipher
     */
     ...
     * @throws InvalidKeyException                if the key is inappropriate for initializing the
     *                                            underlying block cipher.
     * @throws InvalidAlgorithmParameterException if the parameters are inappropriate for initializing the
     *                                            underlying block cipher.
     */
     ...
     * @param cipherParams the parameters
     * @throws InvalidKeyException                if the given key is inappropriate for this cipher.
