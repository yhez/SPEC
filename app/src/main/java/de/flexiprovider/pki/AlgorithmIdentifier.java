...
public class AlgorithmIdentifier extends codec.x509.AlgorithmIdentifier {
     ...
     * in this structure.
     * @throws de.flexiprovider.api.exceptions.NoSuchAlgorithmException           if no matching AlgorithmParameters engine is found.
     * @throws de.flexiprovider.api.exceptions.InvalidAlgorithmParameterException if the parameters cannot be decoded properly.
     */
