...
final class BitMatrixParser {
  ...
  /**
   * @param bitMatrix {@link zxing.common.BitMatrix} to parse
   ...
   *
   * @return {@link zxing.qrcode.decoder.Version} encapsulating the QR Code's version
  ...
  /**
   * <p>Reads the bits in the {@link zxing.common.BitMatrix} representing the finder pattern in the
