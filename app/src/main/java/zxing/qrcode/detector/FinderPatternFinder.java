...
public class FinderPatternFinder {
  ...
  /**
   * @return the 3 best {@link zxing.qrcode.detector.FinderPattern}s from our list of candidates. The "best" are
   *         those that have been detected at least {@link #CENTER_QUORUM} times, and whose module
   *         size differs from the average among those patterns the least
   * @throws zxing.NotFoundException if 3 such finder patterns do not exist
   */
  ...
  /**
   * <p>Orders by {@link zxing.qrcode.detector.FinderPattern#getCount()}, descending.</p>
   */
